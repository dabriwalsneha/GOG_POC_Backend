...
const TREE_DATA = JSON.stringify({
  ...
  "Expenditure Estimate": {
    "Standing Charges Estimate":{
    "Upload Estimates/Correction(Without CSS)": 'uploadEstimates',
    "Estimate Processing": 'app',
    "Upload Estimates": 'app'
    }
  },
  "Receipt Estimate": {
    angular: {
  ...
  "Consolidation of Revenue Receipt": {
    'Photo Booth Library': {
      Contents: 'dir',
      Pictures: 'dir'
    },
